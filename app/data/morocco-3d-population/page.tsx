...
export default function Morocco3DPopulation() {
  ...
  return (
    <div style={{ background: EARTH.paper, minHeight: '100vh', fontFamily: "'IBM Plex Mono', monospace", color: EARTH.ink }}>
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '80px 24px 0' }}>
        <a href="/data" style={{ fontSize: 10, letterSpacing: '0.12em', textTransform: 'uppercase' as const, color: EARTH.muted, textDecoration: 'none' }}>
          ← All Data Modules
        </a>
