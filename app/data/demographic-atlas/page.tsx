...
const REGIONS = [
  ...
  { name: 'Rabat-Salé-Kénitra', pop: 5133, growth: 1.06, urban: 70.7, illiteracy: 22.4, fertility: 1.9 },
  { name: 'Marrakech-Safi', pop: 4892, growth: 0.79, urban: 46.0, illiteracy: 28.8, fertility: 2.2 },
  { name: 'Fès-Meknès', pop: 4468, growth: 0.82, urban: 58.3, illiteracy: 26.4, fertility: 2.1 },
  { name: 'Tanger-Tétouan-Al Hoceïma', pop: 4030, growth: 1.25, urban: 62.5, illiteracy: 25.1, fertility: 2.0 },
  { name: 'Souss-Massa', pop: 3020, growth: 1.12, urban: 53.8, illiteracy: 27.2, fertility: 2.1 },
  { name: 'Béni Mellal-Khénifra', pop: 2520, growth: 0.45, urban: 48.2, illiteracy: 32.0, fertility: 2.3 },
  { name: 'Oriental', pop: 2430, growth: 0.68, urban: 62.1, illiteracy: 28.3, fertility: 2.0 },
  { name: 'Drâa-Tafilalet', pop: 1760, growth: 0.52, urban: 36.7, illiteracy: 30.5, fertility: 2.4 },
  { name: 'Guelmim-Oued Noun', pop: 440, growth: 0.88, urban: 62.8, illiteracy: 27.8, fertility: 2.2 },
  { name: 'Laâyoune-Sakia El Hamra', pop: 420, growth: 1.18, urban: 92.4, illiteracy: 15.3, fertility: 2.1 },
        ...
        <div className="border-t pt-8" style={{ borderColor: C.border }}>
          ...
          <div className="mt-4 p-4 rounded-sm" style={{ background: `${C.pop}04` }}>
            <p className="font-mono text-[12px] leading-[1.7]" style={{ color: C.text }}>
              ...
              growth rate in the kingdom. The slowest: Béni Mellal-Khénifra (0.45%/yr), the
        ...
        <div className="border-t pt-8" style={{ borderColor: C.border }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
            ...
            <div className="p-4 border rounded-sm" style={{ borderColor: C.elder }}>
              ...
              <p className="font-mono text-[11px]" style={{ color: C.text }}>
                Southern and mountain provinces — Taounate, Chefchaouen, Drâa-Tafilalet — above
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-[12px] leading-[1.7]" style={{ color: C.text }}>
                ...
                in Drâa-Tafilalet. One Morocco is converging with Europe&apos;s ageing future.
            ...
            <div>
              ...
              <p className="text-[12px] leading-[1.7]" style={{ color: C.text }}>
                ...
                and education. The cooperatives — argan, textile, agriculture — fill some
