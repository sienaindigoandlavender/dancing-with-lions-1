    ...
    <div className="-mt-16">
      ...
      <section style={{ background: '#0a0a0a' }}>
        <div className="max-w-wide mx-auto px-6 md:px-10 py-section">
          ...
          <p className="text-[16px] max-w-[560px] leading-relaxed mb-12" style={{ color: 'rgba(255,255,255,0.4)' }}>A riad can be 5&ndash;8&deg;C cooler than the street outside. No air conditioning. No fans. Just geometry, water, and thermal mass working together for a thousand years.</p>
            ...
            {CLIMATE_SYSTEM.map((c, i) => {
              ...
              return (
                <div key={c.feature} data-sid={`climate-${i}`} className="p-8 transition-all duration-700" style={{ background: '#0f0f0f', opacity: isVisible ? 1 : 0, transform: isVisible ? 'translateY(0)' : 'translateY(12px)' }}>
                  <span className="text-[10px] uppercase tracking-[0.08em] tabular-nums" style={{ color: '#3B82F6' }}>{String(i + 1).padStart(2, '0')}</span>
