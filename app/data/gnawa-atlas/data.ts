...
export const INSTRUMENTS: Instrument[] = [
  {
    ...
    description: 'Three-stringed bass plucked lute. The soul of Gnawa music. Only played by the maalem (master musician). Approximately guitar-sized, with a body carved from a single log and covered with camel skin.',
    ...
    construction: 'The body is hollowed from a halved tree trunk into a rectangular or canoe shape. Camel skin is stretched over the playing side (functions like a banjo membrane). The neck — a simple wooden stick — passes through the body, emerging through the skin at the base as a tailpiece/string carrier. Three strings of different thickness: the lowest is a drone (never fretted), the middle string is tuned an octave higher (also a drone, half-neck length), and the highest is the melodic string. Dimensions: approximately 1.2m total length; box approximately 55cm × 19cm × 14cm. Often decorated with henna patterns on the skin.',
    playing: 'Strings plucked downward with knuckle side of index finger and inside of thumb. Simultaneously, the player slaps the camel skin body with free fingers for percussive tones — creating a sound like pizzicato cello meets hand drum. The result is both melodic and percussive at once. Common tunings: C, D, F, G. Pentatonic scales predominate.',
    role: 'The guembri is the master of the ceremony. It attracts the mluk (spirits) into the dance space and drives trance. Only the maalem plays it. In the lila, the guembri opens the treq (path) — the strictly encoded sequence of ritual repertoire.',
  ...
  },
  {
    ...
    arabic: 'قراقب',
    description: 'Large iron castanets in a figure-8 shape. The relentless metallic pulse of Gnawa music. Played by the ensemble (kouyou) accompanying the maalem.',
    ...
    construction: 'Each castanet is two metal shells joined at one end. The player holds one pair in each hand. When struck together, they produce a sharp, penetrating, metallic clap. The sound has been described as evoking the loudness of chains — a sonic memory of slavery.',
    ...
    role: 'The qraqeb maintain the rhythmic foundation while the guembri leads melodically. Together, they create the polyrhythmic 3:2 hemiola characteristic of trance music worldwide. The sound is designed to induce temporal trance — a dissociation from ordinary time.',
...
export const MAALEMS: Maalem[] = [
  { name: 'Maâlem Mahmoud Guinia', years: '1951–2015', city: 'Essaouira', lineage: 'Son of Maâlem Boubker Guinia (1927–2000) and moqaddema A\'isha Qabral. Family from present-day Mali and Mauritania — soldiers in the sultan\'s army, not slave-descended. Brothers Abdellah (d. 2013), Mokhtar, and Bilal also maalems. Sister Zaida is a moqaddema.', significance: 'The King. Most revered Gnawa musician internationally. Elevated the tradition to world stages while preserving ancestral repertoire. His 1994 album "The Trance of Seven Colors" (with Pharoah Sanders, produced by Bill Laswell) is the defining Gnawa recording. At his final concert in Essaouira (May 2015), visibly ill, he handed his guembri to his son Houssam — the passing of the lineage. Died August 2, 2015.', collaborations: 'Pharoah Sanders, Carlos Santana, Peter Gabriel, Peter Brötzmann, Bill Laswell, James Holden, Floating Points', style: 'Marsaoui (Essaouira style). Deep spiritual authority. Trance-inducing vocals and virtuosic guembri.' },
  { name: 'Maâlem Mustapha Baqbou', years: 'c. 1953–2025', city: 'Marrakech', lineage: 'Born into a Gnawa family in Marrakech. Brother Ahmed Baqbou also a maalem. Trained in the purest Marrakchi tradition.', significance: 'Bridge between Gnawa ritual percussion and Morocco\'s 1970s folk revival (member of Jil Jilala). Preserved the Marrakchi style — considered more percussive and urban than the Essaouira school. Lifelong dedication to maintaining ceremonial purity.', collaborations: 'Jil Jilala, various European festival partnerships', style: 'Marrakchi style. Urban, percussive, deeply traditional. Purist approach to lila ceremony.' },
  { name: 'Maâlem Hamid El Kasri', years: 'b. Ksar El Kebir', city: 'Rabat (from Ksar El Kebir)', lineage: 'Northern Moroccan origins. Began apprenticeship at age 7 in the Tangier gnawa scene under master Abdelwahab "Stitou."', significance: 'One of the biggest Gnawa stars. Renowned for his voice — possibly the most celebrated in contemporary Gnawa. Bridges northern (gharbaoui/shamali), Essaouira (marsaoui), and southern Berber (soussi) styles. Has introduced Gnawa to broader mainstream Moroccan audiences.', collaborations: 'Jacob Collier, Snarky Puppy, numerous international festivals', style: 'Fusion of northern, southern, and coastal Gnawa styles. Powerful vocals. Accessible to secular audiences while maintaining spiritual depth.' },
  { name: 'Maâlem Hassan Hakmoun', years: 'b. 1963, Marrakech', city: 'Marrakech → New York City', lineage: 'Mother is a known mystic healer in Marrakech. Performing from age 4 alongside snake charmers and fire-breathers in Djemaa el-Fna.', significance: 'The international ambassador. First Gnawa musician to establish a major career in the West (based in NYC since late 1980s). Debut at Lincoln Center 1987. Rolling Stone "Hot Pick of \'94." Worked with Peter Gabriel. Introduced Gnawa to Western concert audiences through recordings and tours.', collaborations: 'Peter Gabriel, Don Cherry, various world music projects', style: 'Maintains Gnawa stamp while incorporating modern influences. Marrakchi roots with Western concert sensibility.' },
  { name: 'Maâlem H\'mida Boussou', years: '1939–2007', city: 'Casablanca (from Marrakech)', lineage: 'Family traced to the Boussou tribe, originally near Lake Chad, later deported to Mauritania by Touareg. Taught by Maâlem Ahmed Oueld Dijja. Became maalem at 16. Also worked with Maâlem Sam (1962–68).', significance: 'The Grand Master. One of the most deeply respected traditionalists. His Casablanca ceremonies were legendary for their spiritual intensity. Son Hassan Boussou continues the tradition.', collaborations: 'Primarily ceremonial. Rare festival appearances preserved maximum spiritual authority.', style: 'Pure traditional. Casablanca base but Marrakchi roots. Ceremony over performance.' },
  { name: 'Maâlem Abdellah El Gourd', years: 'Active from Tangier', city: 'Tangier', lineage: 'Self-taught. Learned Gnawa while working as a radio engineer. Represents the Tangier school — northern Gnawa with shamali influences.', significance: 'Key collaborator with Randy Weston, the jazz pianist who relocated to Morocco in 1968. Co-produced "The Splendid Master Gnawa Musicians of Morocco" — 1996 Grammy nomination for Best World Music Album. Also collaborated with Archie Shepp and Johnny Copeland. The Gnawa-jazz bridge.', collaborations: 'Randy Weston, Archie Shepp, Johnny Copeland', style: 'Northern (shamali) Gnawa. Jazz-adjacent sensibility. Improvisational openness.' },
  ...
  { name: 'Maâlem Majid Bekkas', years: 'b. Salé', city: 'Salé / Rabat', lineage: 'Started playing banjo in 1972 with Moroccan "Jil" groups. Established Gnaoua Blues Band in 1990s.', significance: 'The Gnawa-blues theorist. His album "African Gnaoua Blues" (2001) made explicit the connections between Gnawa pentatonic scales, call-and-response, and American blues. Plays guembri, oud, and slide guitar. Demystified the Gnawa-blues link for international audiences.', collaborations: 'Ramon Lopez, various European jazz musicians', style: 'Gnaoua Blues fusion. Intellectual, cross-cultural. Guitar and oud alongside guembri.' },
]
...
export const KEY_NUMBERS = [
  { number: '7', context: 'Spirit families (mluk), each with its own colour, incense, rhythm, suite of songs, and style of dance. The lila is a journey through all seven realms — white to yellow, holy to joyous, from dusk to dawn' },
  { number: '3', context: 'Strings on the guembri. Goat gut on a body of hollowed wood covered in camel skin. The lowest string is a drone — never fretted. The instrument is both melody and percussion at once' },
  { number: '1998', context: 'First Gnaoua and World Music Festival in Essaouira. From 20,000 attendees to 200,000+ by 2006. Free concerts. The festival that made Gnawa a global phenomenon while honouring its spiritual roots' },
  { number: '1951–2015', context: 'Lifespan of Maâlem Mahmoud Guinia — the King. Son of Boubker Guinia, father of Houssam. Three generations of the most revered Gnawa lineage, all from Essaouira' },
  { number: '200,000+', context: 'Peak annual attendance at the Essaouira Gnaoua Festival. Morocco\'s largest music event. Pat Metheny, Marcus Miller, Didier Lockwood have all performed with Gnawa masters on its stages' },
  { number: '16th C', context: 'The century from which Gnawa practice is documented in Morocco — though enslaved West Africans arrived earlier. Five hundred years of unbroken spiritual tradition, surviving slavery, colonialism, and commercialisation' },
]

export const REGIONAL_STYLES = [
  { name: 'Marsaoui', city: 'Essaouira', character: 'Atlantic coast style. Greater prominence of the guembri. Considered the most melodically sophisticated. The Guinia family dynasty. Named for the city\'s old name: al-Sawira / Mogador' },
  { name: 'Marrakchi', city: 'Marrakech', character: 'Urban imperial city style. More percussive, with stronger tbel and ganga elements. The Baqbou family. Djemaa el-Fna street performance tradition. The most visible to tourists' },
  ...
  { name: 'Soussi', city: 'Agadir / Southern Morocco', character: 'Berber-influenced. Greater role for ganga (drum). Rural ceremonial context. The oldest layer — may preserve pre-Islamic African elements more fully' },
  { name: 'Casablanca', city: 'Casablanca', character: 'Urban synthesis. H\'mida Boussou\'s legendary ceremonies. Draws from multiple regional traditions. The metropolis as melting pot' },
]
...
export const KEY_VOCABULARY = [
  ...
  { term: 'Sidi Bilal', arabic: 'سيدي بلال', definition: 'Bilal ibn Rabah — Ethiopian-born first muezzin of Islam, freed slave of the Prophet Muhammad. The founding spiritual ancestor of all Gnawa. The figure who legitimises Gnawa identity within Islam' },
  { term: 'Fraja', arabic: 'فرجة', definition: '"Show" or "spectacle." The Gnawa term distinguishing secular public performances from sacred lila ceremonies. Concerts are fraja; private healing ceremonies are lila. The distinction matters deeply to traditionalists' },
]
