    ...
    <div className="-mt-16">
      ...
      <section style={{ background: '#0a0a0a' }}>
        <div className="max-w-wide mx-auto px-6 md:px-10 py-section">
          ...
          <p className="text-[16px] max-w-[560px] leading-relaxed mb-12" style={{ color: 'rgba(255,255,255,0.4)' }}>OCP doesn&rsquo;t just mine phosphate. It extracts, processes, customizes, and ships. The integrated model is the competitive advantage.</p>
