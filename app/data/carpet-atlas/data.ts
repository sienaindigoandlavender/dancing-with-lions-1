...
export const RUG_TRADITIONS: RugTradition[] = [
  {
    ...
    detail: 'The most internationally recognized Moroccan rug. Le Corbusier, Alvar Aalto, and Marcel Breuer paired them with modernist furniture in the 1920s–30s. Matisse called them "the white giants." Originally made to insulate entire tent floors against Atlas winters. The tribes settled around Jebel Bouiblane circa 9th century, bringing flat weaving traditions. The wool comes from Atlas mountain sheep — finer and more supple than western Moroccan breeds.',
    modernNote: 'Mid-century modern revival drove global demand. Widely copied commercially — authentic pieces identified by hand-spun irregularity, natural lanolin smell, and tribal provenance.',
  ...
  },
  {
    ...
    detail: 'Often confused with Beni Ourain. Distinguished by exceptionally tight knotting that creates a denser, more durable surface. The fine wool has a refined feel and firm underfoot support. Less well-known internationally but prized by collectors for superior craftsmanship.',
  ...
  },
  {
    ...
    motifs: 'Freeform abstract compositions. Asymmetric diamonds, imperfect repeating lines, Amazigh symbols for marriage, birth, protection, love. Each rug is a personal autobiography.',
    ...
    modernNote: 'Discovered by Western collectors in the late 20th century. Now among the most sought-after for their "contemporary art" aesthetic — often compared to abstract expressionism.',
  ...
  },
  {
    ...
    detail: 'From a small town that was once a sacred site belonging to many tribes. The bold hues are entirely plant-derived — no artificial chemicals. The limp profile makes them easy to move. Vintage pieces (pre-1970s) are highly collectible. Often copied by commercial brands going for bohemian style, but never matched.',
    modernNote: 'Instagram darling of the bohemian interiors world. Authentic vintage Boujaads are increasingly rare and command premium prices.',
  ...
  },
  {
    ...
    detail: 'The only major Moroccan rug tradition featuring both a soft and a flat side, making them truly reversible. Characterised by double loop knots creating exceptional density. Older pieces develop a beautiful softly faded tonal quality over decades. Famous for indigo blues and purples. Bright pink pieces may indicate a bleach wash on vintage originals.',
  ...
  },
  {
    ...
    detail: 'Requires the highest level of skill among Moroccan flat-weaves. The reversible design means colours of symbols invert on each side — a tour de force of counting and tension control. Traditionally from the Southeast, but Middle Atlas weavers have developed a non-reversible interpretation without side tassels. Made with Siroua sheep wool, known for long, smooth, lustrous fibres.',
  ...
  },
  {
    ...
    detail: 'A major hub for Amazigh rug production. Encompasses multiple sub-styles: Glaoui (three techniques: weaving + knotting + chedwi embroidery), Akhnif (fine micro-motifs on monochrome ground), and Zanafi. The Siroua sheep breed produces wool with natural lustre — a hallmark of these textiles. Vintage pieces from the 1940s–60s are highly collectible.',
  ...
  },
  {
    ...
    modernNote: 'The ultimate sustainable textile. Celebrated in global design circles. Newer pieces include synthetics; older pieces use naturally dyed cottons and fabrics.',
  ...
  },
  {
    ...
    detail: 'Close neighbours to the Beni Ourain tribes, often confused with them. Distinguished by lighter weight, smaller size, and their signature large criss-cross diamond pattern. The pure undyed wool palette gives them a raw, elemental quality. Multiple sub-tribe names exist within the Marmoucha confederation.',
...
export const SYMBOLS: AmazighSymbol[] = [
  { id: 'diamond', name: 'Diamond (Lozenge)', meaning: 'Femininity, fertility, protection', shape: '◇', detail: 'The most important motif. Represents the woman herself — strong, creative, central to family. A single lozenge = a womb. Chains of diamonds = continuity of life and lineage.' },
  ...
  { id: 'yaz', name: 'Yaz (ⵣ)', meaning: 'Amazigh identity, freedom', shape: 'ⵣ', detail: 'The Tifinagh letter for "free man." The boldest identity symbol — proclaiming Amazigh heritage and the unbreakable spirit of a free people.' },
]

export const NATURAL_DYES = [
  { source: 'Madder root', color: '#C0392B', produces: 'Deep reds, crimson', note: 'The most important dye plant. Root is boiled and fermented.' },
  { source: 'Indigo', color: '#1A237E', produces: 'Blues, purples', note: 'Used extensively by Beni M\'Guild. Creates the famous "Berber blue."' },
...
export const KEY_NUMBERS = [
  ...
  { value: '1990s', label: 'Azilal enters the market', note: 'Unknown to Western collectors until the late 20th century. Now among the most coveted.' },
  { value: 'Mid-20th C', label: 'Boucherouite emerges', note: 'Women began using recycled textiles when wool became scarce. Necessity birthed art.' },
  ...
  { value: 'Siroua', label: 'Prized sheep breed', note: 'Long, smooth, lustrous fleece. Exclusive to Taznakht region. The finest Moroccan rug wool.' },
]
