...
export default function GreenSahara() {
    ...
    <div style={{ background: C.bg, color: C.ink }}>
      ...
      <Sec>
        <Fade>
          ...
          <Body>This is a prequel. The next chapter is <a href="/data/dust-that-feeds" style={{ color: '#5E60CE', textDecoration: 'underline' }}>The Dust That Feeds</a>. The sequel is <a href="/data/phosphate-equation" style={{ color: '#5E60CE', textDecoration: 'underline' }}>The Phosphate Equation</a>.</Body>
        </Fade>
      </Sec>
      ...
      <footer>
        <div style={{ background: '#1f1f1f', padding: '40px 24px' }}>
          <div style={{ maxWidth: 800, margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 16 }}>
            ...
            <span style={{ fontFamily: F.mono, fontSize: 11, color: 'rgba(255,255,255,0.25)' }}>Dancing with Lions · Earth Systems</span>
          </div>
        </div>
