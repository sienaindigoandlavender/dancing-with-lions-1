...
// ── MAIN ──
export default function TheLastLions() {
    ...
    <div style={{ background: C.bg, color: C.ink }}>
      ...
      <Section>
        <Fade>
          ...
          <Body>Dancing with Lions is named for this animal. Not the African lion of the Serengeti documentary, but the Atlas lion of the Moroccan mountains — the one that was lost, preserved by kings, and might one day return.</Body>
        </Fade>
      </Section>
      ...
      <footer>
        <div style={{ background: '#1f1f1f', padding: '40px 24px' }}>
          <div style={{ maxWidth: 800, margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 16 }}>
            ...
            <span style={{ fontFamily: F.mono, fontSize: 11, color: 'rgba(255,255,255,0.25)' }}>Dancing with Lions · Cultural Intelligence</span>
          </div>
        </div>
