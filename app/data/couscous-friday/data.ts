...
export const VARIATIONS: Variation[] = [
  ...
  { name: 'Saykouk', arabic: 'سيكوك', region: 'Nationwide — summer', detail: 'Cold buttermilk couscous. Steamed semolina cooled and topped with cold lben (buttermilk), sweetened with sugar. Summer variation. No meat, no broth, no heat. Refreshing, simple, a completely different experience from the Friday standard.', keyIngredient: 'Cold lben (buttermilk) + sugar' },
...
export const TECHNIQUE: Technique[] = [
  ...
  { step: 3, name: 'Break and oil', arabic: 'التفتيل', detail: 'Return couscous to the gsaa. Break up clumps by hand. Drizzle with olive oil and water. Rake again. Season with salt. The grains must remain individual — never a mass. This step separates a good couscous from a great one.', duration: '10 min' },
...
export const BIBLIOGRAPHY = [
  { source: 'UNESCO Decision 15.COM/8.b.14', detail: 'Knowledge, know-how and practices pertaining to the production and consumption of couscous. Joint: Algeria, Mauritania, Morocco, Tunisia. No. 01602. December 2020.', url: 'https://ich.unesco.org/en/Decisions/15.COM/8.b.14' },
