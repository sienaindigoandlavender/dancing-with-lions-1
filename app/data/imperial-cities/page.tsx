    ...
    <div className="-mt-16">
      ...
      <section style={{ background: '#0a0a0a' }}>
        <div className="max-w-wide mx-auto px-6 md:px-10 py-section">
          ...
          <h2 className="font-serif text-[28px] md:text-[36px] italic leading-[1.05] mb-4" style={{ color: '#ffffff' }}>Four Capitals, Seven Dynasties</h2>
      ...
      <section className="bg-white">
        <div className="max-w-wide mx-auto px-6 md:px-10 py-section">
          ...
          <h2 className="font-serif text-[28px] md:text-[36px] italic text-dwl-black leading-[1.05] mb-12">Each One a Kingdom</h2>
      ...
      <section style={{ background: '#0a0a0a' }}>
        <div className="max-w-wide mx-auto px-6 md:px-10 py-section">
          ...
          <h2 className="font-serif text-[28px] md:text-[36px] italic leading-[1.05] mb-8" style={{ color: '#ffffff' }}>Seven Houses, One Throne</h2>
