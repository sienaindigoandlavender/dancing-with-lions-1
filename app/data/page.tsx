...
const MODULES = [
  ...
  { id: 'moroccan-genome', category: 'Genetic Intelligence', title: 'The Moroccan Genome', entries: '5 ancestry components × 7 Y-haplogroups × 5 mtDNA lineages × 10 E-M81 populations × 10 timeline events', status: 'Live', description: 'What DNA says about who Moroccans are. 51% autochthonous North African ancestry found nowhere else on Earth. E-M81 at 80–98% in Amazigh men — only 2,000 years old. Almost no genetic difference between Arab and Berber speakers. 300,000 years from Jebel Irhoud to the 2025 Moroccan Genome Project.', fields: ['Ancestry', 'Haplogroup', 'Frequency', 'Population', 'Date', 'Source'], href: '/data/moroccan-genome' },
