...
export const REGIONS: OliveRegion[] = [
  ...
  { id: 'beni-mellal', name: 'Béni Mellal-Khénifra', detail: 'Middle Atlas foothills. Jurassic-era valleys with mineral-rich soils. Naturally high polyphenol levels. In good years, 22–24 litres oil per quintal. Home to Morocco Gold estate (2,000 ft elevation). Sanhaja Berber olive tradition spanning millennia.', hectares: '~200,000 ha', profile: 'Distinctive, fruity. High polyphenol. Peppery finish.', lat: 32.34, lng: -6.36, color: '#EF4444' },
  { id: 'tanger-tetouan', name: 'Tangier-Tétouan-Al Hoceima', detail: 'Northern Morocco. 150+ modern crushing units. Ouezzane province: 70 modern + 306 traditional mills. Picholine Marocaine 70%, Haouzia + Menara ~20%. Herbaceous, green oils. Small-scale artisan production. Organic Rif mountain farms.', hectares: '~180,000 ha', profile: 'Herbaceous, green, fresh. Rif mountain character.', lat: 35.17, lng: -5.27, color: '#3B82F6' },
  { id: 'oriental', name: 'Oriental (Taourirt / Oujda)', detail: 'Eastern Morocco. Drier conditions produce concentrated flavours. Growing region with investment from Green Morocco Plan. Traditional Picholine groves.', hectares: '~80,000 ha', profile: 'Robust, concentrated. Arid-climate intensity.', lat: 34.68, lng: -1.90, color: '#A855F7' },
  { id: 'souss-massa', name: 'Souss-Massa (Taroudant)', detail: 'Southern region. Lighter, golden oils ideal for international markets. Arid conditions stress trees, concentrating flavour compounds. Growing export focus.', hectares: '~100,000 ha', profile: 'Light, golden. Ideal for export markets.', lat: 30.40, lng: -9.00, color: '#F97316' },
]
