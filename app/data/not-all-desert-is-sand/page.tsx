            ...
            {MOROCCAN_ERGS.map((e, i) => (
              <div key={i} className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-10 py-10" style={{ borderTop: i === 0 ? 'none' : '1px solid rgba(255,255,255,0.06)' }}>
                ...
                <div className="md:col-span-2">
                  ...
                  <p className="text-[12px]" style={{ color: 'rgba(255,255,255,0.35)' }}>{e.access}</p>
                </div>
              </div>
            ))}
          </div>
...
{/* ═══ SAHARA IN NUMBERS ═══ */}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-8">
            {SAHARA_FACTS.map((f, i) => (
              <div key={i} className="py-4" style={{ borderBottom: '1px solid rgba(255,255,255,0.2)' }}>
                ...
                <p className="text-[10px] mt-2" style={{ color: 'rgba(255,255,255,0.4)' }}>{f.source}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <footer>
        <div style={{ backgroundColor: '#1f1f1f' }} className="py-16 px-8 md:px-[8%]">
          <p className="text-[11px] tracking-[0.15em] uppercase" style={{ color: 'rgba(255,255,255,0.4)' }}>Module 073 · Not All Desert Is Sand · © Dancing with Lions</p>
        </div>
