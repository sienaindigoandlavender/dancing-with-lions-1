...
export default function NotAllDesertIsSandPage() {
  ...
  return (
    <main className="min-h-screen bg-[#0a0a0a] text-[#e5e5e5]" style={{ fontFamily: "'IBM Plex Mono', monospace" }}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-2 mb-8">
            {DESERT_TYPES.map((t, i) => (
              <button key={i} onClick={() => setActiveType(i)}
                className={`text-left p-4 border transition-all duration-300 ${activeType === i ? 'bg-white/[0.02]' : 'hover:border-neutral-700'}`}
            ...
            <div className="flex flex-col lg:flex-row gap-8">
              <div className="flex-1">
                ...
                <div className="space-y-3 text-sm text-neutral-400 leading-relaxed">
                  ...
                  <p className="text-neutral-300 pt-2 border-t border-neutral-800/50">{DESERT_TYPES[activeType].detail}</p>
              ...
              <div className="lg:w-72 flex-shrink-0">
                <div className="border border-neutral-800 p-4" style={{ backgroundColor: TYPE_COLORS[DESERT_TYPES[activeType].name] + '08' }}>
      ...
      {/* ── MOROCCO'S ERGS ── */}
      <section data-sid="ergs" className="py-24 px-6 border-t border-neutral-900">
          ...
          <div className="flex gap-2 mb-8">
            {MOROCCAN_ERGS.map((e, i) => (
              <button key={i} onClick={() => setActiveErg(i)}
                className={`flex-1 text-left p-3 border transition-all duration-300 ${activeErg === i ? 'border-[#E8A94E]/60 bg-[#E8A94E]/5' : 'border-neutral-800 hover:border-neutral-700'}`}>
      ...
      {/* ── SAHARA IN NUMBERS ── */}
      <section data-sid="sahara" className="py-24 px-6 border-t border-neutral-900">
          ...
          <div className="space-y-3">
            {visibleFacts.map((f, i) => (
              <div key={i} className="flex flex-col md:flex-row md:items-start gap-2 md:gap-6 border border-neutral-800 p-4 hover:border-neutral-700 transition-colors">
                ...
                <div className="flex-1">
                  <span className="text-sm text-neutral-300">{f.value}</span>
                </div>
      ...
      {/* ── SURFACE COMPOSITION ── */}
      <section data-sid="composition" className="py-24 px-6 border-t border-neutral-900">
        <div className={`max-w-6xl mx-auto transition-all duration-1000 ${vis('composition') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          {/* Visual bar */}
          <div className="mb-8">
            <div className="flex h-12 overflow-hidden border border-neutral-800">
      ...
      <section data-sid="timeline" className="py-24 px-6 border-t border-neutral-900">
        <div className={`max-w-6xl mx-auto transition-all duration-1000 ${vis('timeline') ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <p className="text-sm text-neutral-400 max-w-2xl mb-8 leading-relaxed">The desert is young. The landscape is ancient.</p>
