    ...
    <div className="-mt-16">
      ...
      <section className="bg-white">
        <div className="max-w-wide mx-auto px-6 md:px-10 py-section">
          ...
          <h2 className="font-serif text-[28px] md:text-[36px] italic text-dwl-black leading-[1.05] mb-4">10 Named Markets, One Organism</h2>
      ...
      <section style={{ background: '#0a0a0a' }}>
        <div className="max-w-wide mx-auto px-6 md:px-10 py-section">
          ...
          <h2 className="font-serif text-[28px] md:text-[36px] italic leading-[1.05] mb-12" style={{ color: '#ffffff' }}>Six Rules of Souk Spatial Logic</h2>
      ...
      <section className="bg-white">
        <div className="max-w-wide mx-auto px-6 md:px-10 py-section">
          ...
          <h2 className="font-serif text-[28px] md:text-[36px] italic text-dwl-black leading-[1.05] mb-4">Five Ranks, One Trade</h2>
      ...
      <section className="bg-white">
        <div className="max-w-wide mx-auto px-6 md:px-10 py-section">
          ...
          <h2 className="font-serif text-[28px] md:text-[36px] italic text-dwl-black leading-[1.05] mb-12">The Numbers Behind the Maze</h2>
