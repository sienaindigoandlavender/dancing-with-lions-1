...
export const SOUKS_MARRAKECH: SoukSection[] = [
  ...
  { id: 'smata', name: 'Souk Smata', specialty: 'Babouches (slippers)', position: 'Side passage off main spine', note: 'Rows of leather slippers in every color. Pointed-toe for men, rounded for women. The most photogenic souk.', color: '#EC4899' },
