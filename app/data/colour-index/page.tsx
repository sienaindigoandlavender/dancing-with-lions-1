...
interface MoroccanColour {
  ...
  source: string // mineral, pigment, or material origin
  where: string // where it appears
  meaning: string // cultural significance
  chemistry?: string // what makes the colour
  city?: string // primary city association
  note?: string // bonus detail
  featured?: boolean
}
...
export default function ColourIndexPage() {
  ...
  return (
    <div className="min-h-screen bg-white" style={{ color: C.ink }}>
      ...
      {/* ═══ SOURCES ═══ */}
      <section className="max-w-[1200px] mx-auto px-6 md:px-10 py-section">
        <p className="micro-label mb-4" style={{ color: C.muted }}>Sources &amp; Methodology</p>
