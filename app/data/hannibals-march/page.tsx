...
export default function HannibalsMarch() {
    ...
    <div style={{ background: C.bg, color: C.ink }}>
      ...
      <Section>
        <Fade>
          ...
          <Body>He never took Rome. But he changed the course of Mediterranean civilisation. And it all started in North Africa — in Carthage, modern-day Tunisia, 150 kilometres from where the DWL ecosystem begins.</Body>
        </Fade>
      </Section>
      ...
      <Section bg={C.alt}>
        <Fade>
          ...
          <SectionTitle>Carthage is 150 km from the DWL ecosystem</SectionTitle>
          ...
          <Body>The war elephants were North African forest elephants — the same species that once roamed the Atlas Mountains, now extinct. The Barbary lion that DWL is named for lived in the same forests. North Africa was once teeming with megafauna that shaped Mediterranean civilisation — and then vanished.</Body>
      ...
      <footer>
        <div style={{ background: '#1f1f1f', padding: '40px 24px' }}>
          <div style={{ maxWidth: 800, margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 16 }}>
            ...
            <span style={{ fontFamily: F.mono, fontSize: 11, color: 'rgba(255,255,255,0.25)' }}>Dancing with Lions · Military History</span>
          </div>
        </div>
