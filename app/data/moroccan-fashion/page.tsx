    ...
    <main className="min-h-screen bg-[#0a0a0a] text-[#e5e5e5]" style={{ fontFamily: "'IBM Plex Mono', monospace" }}>
      ...
      <section className="py-16 px-6 border-t border-[#111]">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-[10px] text-[#333] mt-4">© Dancing with Lions — Cultural intelligence from 11 years in Morocco</p>
        </div>
      </section>

      {/* ── BACK LINK ── */}
      <div className="py-8 px-6 text-center">
        <Link href="/data" className="text-[11px] uppercase tracking-[0.12em] text-[#555] hover:text-[#999] transition-colors">← Data Index</Link>
      </div>
