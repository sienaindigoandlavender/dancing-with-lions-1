...
export const THREE_LANGUAGES: Language[] = [
  {
    ...
    percentage2004: 14.6,
    percentage1960: 15,
    description: 'The most widely spoken Amazigh language in Morocco and the largest by geographic spread. Spoken across the Souss-Massa region, the Anti-Atlas, western High Atlas, and reaching into the Draa Valley. Tashelhit speakers — the Ishilhayen or Chleuh — descend from the ancient Masmuda confederation. The language has the richest written tradition among Moroccan Amazigh languages: religious manuscripts in Arabic script survive from the 16th century onward, concentrated in the Souss region. Tashelhit speakers are present in 1,512 of Morocco\'s 1,538 municipalities, reflecting a large trade diaspora of small merchants who settled across the kingdom.',
    keyFeatures: 'Three-vowel system (a, i, u). Extensive voiceless consonant clusters — some words contain no vowels at all (e.g. tskrkst, "you made it shrivel"). Subject-Verb-Object word order. Rich oral literature: fairy tales (timucuha), riddles (tilgitin), tongue-twisters, and improvisational poetry (amarg). Used in Amazigh cinema — the most developed Amazigh film industry.',
    urbanRural: 'Souss-Massa has 63.2% Tashelhit speakers, the only region with a majority. Large urban diaspora in Casablanca and Rabat. The "epicier" (corner shop) stereotype across Morocco is rooted in the Soussi Amazigh trade networks.',
  ...
  },
  {
    ...
    percentage2004: 8.8,
    percentage1960: 10,
    description: 'The second most spoken Amazigh language. Central Atlas speakers — the Imazighen in the exclusive sense — are the only group who use the term "Tamazight" to refer specifically and exclusively to their own language. Spoken across the Middle Atlas, the central and eastern High Atlas, reaching east to Taza and west toward the Rabat region. The territory spans wildly varying ecology: from the forested mountains of the Middle Atlas to the oases of the Tafilalet. Home of the great tribal confederations: the Ait Atta (a "supertribe" claiming descent from 40 sons of ancestor Dadda Atta), the Ait Yafelman ("those who found peace"), and the Zayanes around Khenifra.',
    keyFeatures: 'Relatively high internal dialectal diversity — variation from valley to valley. Phonemic three-vowel system. Has pharyngealized ("emphatic") consonants typical of Afroasiatic. No significant writing tradition before the 20th century. Mutually intelligible with Tashelhit but not with Tarifit. Transitional varieties exist at boundaries.',
  ...
  },
  {
    ...
    percentage2004: 4.8,
    percentage1960: 7,
    description: 'Spoken in the Rif Mountains of northern Morocco by the Riffians (Irifiyen) — historically renowned for fierce independence and terraced mountain agriculture. The Rif was the theater of the great Rif Republic (1921–1926) under Abd el-Krim, the only successful anti-colonial guerrilla state in the Maghreb. Tarifit is the most linguistically distinct of the three — not mutually intelligible with the southern languages. It shares features (interdental consonants θ and ð) with Kabyle and Shawiya in Algeria, classified as rare cross-linguistically. Riffians have the smallest Amazigh population in Morocco and the strongest European diaspora connection, particularly to the Netherlands, Belgium, and northeastern Spain.',
    keyFeatures: 'The rare interdental consonants θ and ð (shared with only Kabyle and Shawiya across all Berber languages). Higher Arabic lexical borrowing than Tashelhit. Verb-Subject-Object order typical of Berber but with significant restructuring under Arabic contact. The most endangered of the three major languages — losing speakers at the fastest rate.',
...
export const MINOR_LANGUAGES: MinorLanguage[] = [
  {
    ...
    note: 'An isolated Masmuda-related language in the northern Rif. Not mutually intelligible with Tarifit. Extremely high Arabic borrowing rate — over 15% core vocabulary. Being replaced by Arabic and Tarifit. Some sources classify it as nearly extinct.',
  },
  {
    ...
    note: 'Spoken by the Senhaja tribes of the Srair (central Rif). Related to neither Tarifit nor Ghomara. Contains unique vocabulary not found elsewhere in Moroccan Amazigh. Over 15% core Arabic borrowing. The cannabis-growing Ketama region falls within Senhaja territory.',
  },
  {
  ...
  },
  {
    ...
    status: 'Endangered',
    note: 'Oasis language in the far east. Uses only eight of the Berber calendar months. Distinctive features: countable mass nouns with gendered forms (e.g. a-ɣo "buttermilk" singular vs u-ɣa "bulls" plural). Extremely isolated — shares features with Algerian Zenati.',
  },
  {
    name: 'Judeo-Berber',
    ...
    note: 'Spoken by Jewish Amazigh communities who emigrated to Israel after 1948. Written in Hebrew script. Surviving speakers are elderly, concentrated in Israeli towns like Ashkelon and Netivot. The last living link to a millennium of Jewish-Amazigh coexistence.',
  },
]
...
export const THREE_CONFEDERATIONS: Confederation[] = [
  {
    ...
    character: 'Sedentary agriculturalists and mountain dwellers. The largest and most settled of the three groups. Aristocratic seat at Aghmat in the High Atlas foothills. Practiced irrigation agriculture in terraced valleys. Formed the population base of southern Morocco.',
  ...
  },
  {
    ...
    character: 'The most geographically dispersed. Ranged from Kabyle Algeria to Saharan Mauritania. In Morocco, they were associated with the Middle Atlas and parts of the Rif. The Saharan Sanhaja — the Lamtuna, Massufa, and Guddala — were the "veiled" Tuareg-related nomads who became the Almoravids. The Sanhaja are often contrasted with the Zenata as the "sedentary vs nomadic" Berber groups, though this is an oversimplification.',
  ...
  },
  {
    ...
    character: 'Nomadic or semi-nomadic pastoralists. The most mobile of the three groups — Ibn Khaldun classified them as "Butr" (nomads) and emphasized their horsemanship and military capacity. They migrated from Tripolitania (Libya) westward, establishing themselves across the Maghreb. Their lifestyle contrasted with the settled Masmuda and the scattered Sanhaja. They dominated post-Almohad Morocco.',
    ...
    descendants: 'Historically the dominant group in eastern Morocco. Today much of their territory has been Arabized — the Zenata language zone largely shifted to Arabic dialects during the post-Almohad period and the Banu Hilal invasions. Small Zenati-speaking pockets survive in far eastern Morocco (Iznasen, Figuig).',
...
export const TIFINAGH_EVOLUTION: TifinaghPhase[] = [
  {
    ...
    description: 'The oldest form. An abjad (consonantal) writing system with ~24 signs, no vowels transcribed. Used in official contexts by the Numidian kingdoms (202–25 BCE). The Dougga bilingual inscription (Punic-Libyc, ~146 BCE) in Tunisia remains the Rosetta Stone of Libyco-Berber studies — one of the few decipherable texts. 22 of 24 Eastern characters have been deciphered through Punic bilingual comparison.',
  ...
  },
  {
    ...
    description: 'The western variant, sometimes called proto-Tifinagh. Found across Morocco and western Algeria. The Azib n\'Ikkis inscription in the Yagour plateau (High Atlas) and the Oukaïmeden engravings are among the most significant Moroccan examples. Undeciphered — lacks the bilingual keys that cracked the Eastern form. Characterized by more angular, geometric signs.',
  ...
  },
  {
    ...
    description: 'When Libyco-Berber died out in Roman-controlled northern Africa, the script survived among the Tuareg in the Sahara. Tuareg Tifinagh evolved with new letters and introduced a vertical line for the vowel /a/. Still used today by the Tuareg in southern Algeria, Mali, Niger, and Burkina Faso. Four distinct Tuareg alphabets exist (Ahaggar, Ajjer, Air, and others). The word "Tifinagh" may derive from the Tuareg tafineq, meaning "character" or "sign" — or from tifin negh, "our invention."',
  ...
  },
  {
    name: 'Neo-Tifinagh',
    period: '1966 – present',
    description: 'Created by the Académie Berbère (Agraw Imazighen), founded in 1966 by Kabyle expatriates in Paris. They adapted traditional Tuareg characters into a modern alphabetic system, rejecting both Latin and Arabic scripts to assert indigenous identity. Ammar Negadi and Messaoud Nedjahi refined the character set from ~50 to 26 signs. The Moroccan state arrested people using Neo-Tifinagh during the 1980s–90s. In 2003, IRCAM adopted a slightly modified Neo-Tifinagh (33 characters) as the official orthography for Standard Moroccan Amazigh. Controversial: most Amazigh speakers do not read Tifinagh. A 2011 survey found 45.5% of respondents considered it the most appropriate script. As of 2024, use remains primarily restricted to public signage, road signs, and culturally visible contexts — not widely used in education, media, or daily life. Only 1.5% of literate Moroccans can read and write in Berber.',
...
export const KEY_NUMBERS = [
  ...
  { value: '900+', context: 'Amazigh associations active in Morocco today. The political continuation of armed tribal resistance against France.' },
  { value: '1.5%', context: 'Of literate Moroccans can read and write in Berber — despite Tifinagh on every road sign. The gap between symbolic recognition and functional literacy.' },
]
