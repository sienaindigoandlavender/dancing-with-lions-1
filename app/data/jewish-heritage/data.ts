...
export const EMIGRATION_WAVES: EmigrationWave[] = [
  ...
  { period: '1961–1964', numbers: '~97,000', detail: 'Operation Yachin. Secret agreement between Mossad\'s Alex Gatmon and Hassan II\'s government. HIAS as the public front. $500,000 down payment + $100 per emigrant (rising to $250 after 50,000th). Families departed by ship from Casablanca and Tangier via Italy, France, or Spain. Entire families required — no individuals.', destination: 'Israel', color: '#EF4444' },
  { period: '1967–1973', numbers: 'Decline to 35,000', detail: 'Six-Day War (1967) and Yom Kippur War (1973) heightened Arab-Jewish tensions. This wave went primarily to France, Canada, and North America rather than Israel. By 1971: 35,000 Jews remained.', destination: 'France / Canada / USA', color: '#A855F7' },
