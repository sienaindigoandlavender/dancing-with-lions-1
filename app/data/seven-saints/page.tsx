...
const SAINTS: Saint[] = [
  ...
  },
  {
    ...
    story: 'The oldest of the seven. Born in Ceuta, he was the greatest Maliki jurist of the Almoravid era and author of al-Shifa, a treatise on the Prophet that is still studied across the Muslim world. He was exiled to Marrakech by the Almohads and died here. His caretaker offers prayers for visitors — and they are said to be answered.',
...
// ═══ MAIN PAGE ═══
export default function SevenSaintsPage() {
