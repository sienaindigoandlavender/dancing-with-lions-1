...
// Arranged in a grid like a botanical illustration or geological chart.
// Every specimen: SVG illustration + name + region + technique + materials.
// Static. Dense. Print at A1.
      ...
      <section style={{ backgroundColor: '#1f1f1f' }} className="px-8 md:px-[8%] lg:px-[12%] py-12">
        <div className="border-t pt-4" style={{ borderColor: 'rgba(255,255,255,0.15)' }}>
          ...
          <p className="text-[11px] leading-[1.6] max-w-[700px]" style={{ color: 'rgba(255,255,255,0.4)' }}>
            ...
            (Dancing with Lions); Tribaliste Magazine craft documentation; field observation
