...
const BROTHERHOODS: Brotherhood[] = [
  {
    ...
    political: 'The most politically consequential brotherhood in African history. Tijani warriors built empires in West Africa (El Hadj Umar Tall\'s Toucouleur Empire). Today Morocco uses the Tijaniyya as its primary instrument of religious diplomacy across sub-Saharan Africa. The Mohammed VI Foundation of African Ulema operates largely through Tijani networks.',
  ...
  },
  {
    ...
    political: 'Historically the most rebellious brotherhood. Darqawi shaykhs led uprisings against both Moroccan sultans and French/Spanish colonizers. Called "ferocious sectarians" and "puritans of Islam" by French administrators. Refused to separate faith from resistance.',
    parent: 'Shadhiliyya',
  ...
  },
  {
    ...
    doctrine: 'Al-Jazuli\'s Dala\'il al-Khayrat is the most widely recited book of prayers on the Prophet after the Quran. His doctrine combined Shadhili mysticism with a popular devotional movement centered on love of the Prophet. Revolutionary for making Sufi practice accessible to common people, not just elites.',
    ...
    political: 'The Jazuliyya was the most politically transformative brotherhood of the 15th–16th century. Jazuli\'s disciples helped bring the Saadian dynasty to power. His body was moved from Essaouira to Marrakech by the Saadians to claim his baraka. Two of the Seven Saints of Marrakech (Sidi Abdelaziz and al-Ghazwani) were his direct students.',
    parent: 'Shadhiliyya',
...
// ═══ MAIN PAGE ═══
export default function ZaouiaMapPage() {
  ...
  return (
    <div className="min-h-screen bg-white" style={{ color: C.ink }}>
      ...
      <section className="max-w-[1000px] mx-auto px-6 md:px-10 pt-36 pb-16">
        ...
        <p className="font-mono text-[10px] uppercase tracking-[0.12em] mb-3" style={{ color: C.muted }}>Module 059 · Sacred Geography</p>
        <div ref={heroR.ref}>
        ...
        <p className="text-[13px] max-w-[560px] leading-[1.7] mt-6" style={{ color: C.text }}>
          ...
          Sufi brotherhoods that hold power without appearing to. The zaouias —
          part shrine, part school, part political base — are where these forces
            ...
            {selectedZaouia && selectedBrotherhood && (
              <div className="absolute bottom-4 left-4 right-4 md:right-auto md:w-[380px] p-5 bg-white/95 backdrop-blur-sm rounded-sm shadow-lg"
                ...
                <p className="font-mono text-[11px] mt-1" style={{ color: C.muted }}>
                  {selectedZaouia.city} · {selectedZaouia.region} · {selectedZaouia.era}
                  {!selectedZaouia.active && <span className="ml-2 text-[#8B3A3A]">· Destroyed</span>}
                </p>
        ...
        <div className="border-t pt-8" style={{ borderColor: C.border }}>
          ...
          <div className="space-y-4 max-w-[600px]">
            ...
            <div>
              ...
              <p className="text-[12px] leading-[1.7]" style={{ color: C.text }}>
                Every tariqa has a silsila — a chain of transmission linking the
      ...
      <section style={{ backgroundColor: '#1f1f1f' }} className="max-w-[1000px] mx-auto px-6 md:px-10 py-8 pb-24">
        <div className="border-t pt-6" style={{ borderColor: 'rgba(255,255,255,0.15)' }}>
          <p className="font-mono text-[9px] leading-[1.8]" style={{ color: 'rgba(255,255,255,0.4)' }}>
            ...
            Bekkaoui, Khalid & Larémont, Ricardo. &quot;Moroccan Youth Go Sufi.&quot; <em>The Journal of the Middle East and Africa</em>, 2011.
