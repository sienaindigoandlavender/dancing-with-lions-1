...
export const REGIONS: PotteryRegion[] = [
  ...
  },
  {
    ...
    description: 'The most distinctive pottery in Morocco. Deep green glaze — sometimes jade, sometimes emerald, sometimes almost black — produced by a secret manganese-copper formula and ancient wood-ash kiln technique. Every piece is irregular, crackled, alive. Utilitarian first: storage jars, water vessels, oil lamps for the desert.',
  ...
  },
  {
    ...
    distinction: 'Made by women. The only Moroccan pottery tradition that is exclusively female. The symbols are the same as those on Amazigh tattoos and carpets — a shared visual language.',
  },
  {
    id: 'meknes',
    name: 'Meknes',
