...
export const CITIES: TradeCity[] = [
  ...
  { name: 'Timbuktu', role: 'Southern hub & scholarly centre', detail: 'Started as a caravanserai (pitstop). Became centre of learning and commerce under Mali Empire. Sankore University. 700,000+ manuscripts. Djinguereber Mosque (1327, architect from Andalusia). UNESCO World Heritage.', lat: 16.77, lng: -3.00, color: '#EF4444' },
  { name: 'Marrakech', role: 'Northern terminus & dynastic capital', detail: 'Founded by Almoravids (1070) partly on wealth from trans-Saharan trade. Controlled last leg of western routes. Fez and Marrakech were "ports on the edge of a great sea — the Sahara."', lat: 31.63, lng: -7.98, color: '#EF4444' },
  { name: 'Fez', role: 'Northern terminus & trading centre', detail: 'Merchants from Fez travelled the Audaghost Trail to Ghana. Private residences in Fez were "built and maintained by wealth hard-earned in the trans-Saharan trade." Intellectual hub receiving scholars from both sides.', lat: 34.03, lng: -5.00, color: '#3B82F6' },
  { name: 'Essaouira (Mogador)', role: 'Atlantic port connecting desert & sea', detail: 'Connected trans-Saharan routes to European maritime trade. Jewish merchants traded between Essaouira and Timbuktu into the 19th century. Gunpowder tea from China reached Timbuktu via Essaouira.', lat: 31.51, lng: -9.77, color: '#22C55E' },
  ...
  { name: 'Kumbi Saleh', role: 'Ghana Empire capital', detail: 'Capital of the Ghana Empire. Separate quarters for Muslim traders and locals. Connected to Sijilmasa via the Audaghost Trail. Sacked by Almoravids 1076.', lat: 15.77, lng: -7.97, color: '#A855F7' },
  { name: 'Gao', role: 'Songhai Empire capital', detail: 'Eastern terminus. Capital of Songhai. Connected to Algiers and Tripoli via central routes. Major river port on the Niger. Invaded by Morocco 1591.', lat: 16.27, lng: 0.05, color: '#3B82F6' },
  { name: 'Djenné', role: 'River trade hub', detail: 'Salt from Timbuktu broken into smaller pieces here, carried into forest by Dyula-Wangara traders. Great Mosque (world\'s largest mud-brick structure). UNESCO.', lat: 13.90, lng: -4.55, color: '#F97316' },
]
...
export const TIMELINE: TimelineEvent[] = [
  ...
  { year: '~830 CE', event: 'First historical references to Ghana Empire. Kumbi Saleh as capital. Western Sahara route to Sijilmasa.', color: '#A855F7' },
  ...
  { year: '1062', event: 'Almoravids from Senegal River valley conquer Morocco, establish Marrakech. Control trans-Saharan routes.', color: '#EF4444' },
  { year: '1076', event: 'Almoravids sack Kumbi Saleh. Ghana Empire collapses. Trade shifts eastward.', color: '#EF4444' },
  { year: '13th C', event: 'Mali Empire rises. Caravans of 5,000–10,000 camels. Timbuktu becomes centre of learning and trade.', color: '#3B82F6' },
  ...
  { year: '1352', event: 'Ibn Battuta visits Taghaza and Mali. Records buildings of salt, caravans of 600 enslaved women, 12,000-camel trains.', color: '#22C55E' },
  { year: '1468', event: 'Songhai takes Timbuktu from Mali. Gao becomes new imperial centre.', color: '#3B82F6' },
  { year: '1591', event: 'Saadian Morocco invades Songhai (Battle of Tondibi). Seeking direct control of salt mines and gold routes. Gnawa origins.', color: '#EF4444' },
