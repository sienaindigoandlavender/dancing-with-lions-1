...
import { WRITERS, LOCATIONS, ERAS, HERO_STATS } from './data'
    ...
    <div className="-mt-16">
      ...
      <section className="py-section flex items-center justify-center min-h-[38vh]" style={{ background: '#D4A373' }}>
        <div className="max-w-[720px] px-6 md:px-10 text-center">
          ...
          <p className="text-[12px] mt-4" style={{ color: 'rgba(255,255,255,0.6)' }}>— Mohamed Choukri, In Tangier (1997)</p>
        </div>
      </section>
      ...
      <section style={{ background: '#0a0a0a' }}>
        <div className="max-w-wide mx-auto px-6 md:px-10 py-section">
          ...
          <p className="text-[16px] max-w-[560px] leading-relaxed mb-10" style={{ color: 'rgba(255,255,255,0.4)' }}>Hotels, cafés, bookshops, cemeteries. The physical spaces where Morocco\'s literary history happened.</p>
      ...
      <section className="py-section flex items-center justify-center min-h-[38vh]" style={{ background: '#0a0a0a' }}>
        <div className="max-w-[720px] px-6 md:px-10 text-center">
          ...
          <p className="text-[12px] mt-4" style={{ color: 'rgba(255,255,255,0.35)' }}>— Explore Parts Unknown / CNN</p>
        </div>
      </section>
      ...
      <section style={{ background: '#0a0a0a' }} className="py-section-sm">
        <div className="max-w-wide mx-auto px-6 md:px-10">
          ...
          <div className="mt-8 pt-6" style={{ borderTop: '1px solid rgba(255,255,255,0.1)' }}>
            ...
            <p className="font-serif text-[18px] italic mt-2" style={{ color: '#D4A373' }}>Source: Dancing with Lions</p>
          </div>
          <div className="mt-6">
