    ...
    <div className="-mt-16">
      ...
      <section className="relative min-h-[100vh] flex flex-col justify-end overflow-hidden" style={{ background: '#0a0a0a' }}>
        <div className="absolute inset-0 pointer-events-none overflow-hidden">
          <svg viewBox="0 0 1200 800" className="w-full h-full opacity-[0.04]" preserveAspectRatio="xMidYMid slice">
            {/* Mountain ridgeline */}
            <path d="M0 600 L100 480 L200 520 L300 400 L400 450 L500 350 L600 420 L700 380 L800 440 L900 360 L1000 430 L1100 470 L1200 500 L1200 800 L0 800 Z" fill="none" stroke="#22C55E" strokeWidth="0.4" />
            <path d="M0 650 L150 530 L300 570 L450 460 L600 510 L750 430 L900 490 L1050 520 L1200 550 L1200 800 L0 800 Z" fill="none" stroke="#22C55E" strokeWidth="0.2" />
          </svg>
        </div>
      ...
      <section className="py-section flex items-center justify-center min-h-[38vh]" style={{ background: '#22C55E' }}>
        <div className="max-w-[720px] px-6 md:px-10 text-center">
          ...
          <p className="text-[12px] mt-4" style={{ color: 'rgba(255,255,255,0.6)' }}>— Abdelsalam Amraji, Rif cannabis farmer, AP (2025)</p>
        </div>
      </section>
      ...
      <section style={{ background: '#0a0a0a' }}>
        <div className="max-w-wide mx-auto px-6 md:px-10 py-section">
          ...
          <p className="text-[16px] max-w-[560px] leading-relaxed mb-8" style={{ color: 'rgba(255,255,255,0.4)' }}>Cannabis in Morocco has been legal, monopolized, banned, tolerated, pardoned, and legalized again — sometimes within the same decade.</p>
      ...
      <section style={{ background: '#0a0a0a' }}>
        <div className="max-w-wide mx-auto px-6 md:px-10 py-section">
          ...
          <p className="text-[16px] max-w-[560px] leading-relaxed mb-12" style={{ color: 'rgba(255,255,255,0.4)' }}>Morocco was the first major hashish producer to legalize — partially. The gap between the legal framework and the reality on the ground is enormous.</p>
      ...
      <section style={{ background: '#0a0a0a' }} className="py-section-sm">
        <div className="max-w-wide mx-auto px-6 md:px-10">
          ...
          <div className="mt-8 pt-6" style={{ borderTop: '1px solid rgba(255,255,255,0.1)' }}>
            ...
            <p className="font-serif text-[18px] italic mt-2" style={{ color: '#22C55E' }}>Sources: UNODC, EMCDDA</p>
          </div>
          <div className="mt-6">
