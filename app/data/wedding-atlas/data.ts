...
export const CEREMONY: CeremonyStage[] = [
  { id: 'khotba', day: 'Weeks–months before', name: 'The Khotba', nameAr: 'الخطبة', duration: 'One evening', color: '#A855F7',
  ...
  { id: 'kaghet', day: 'Day 3 (Wedding day)', name: 'Al Kaghet', nameAr: 'الكاغيط', duration: '30 minutes', color: '#3B82F6',
  ...
  { id: 'wedding', day: 'Day 3 (Evening)', name: 'The Wedding Night', nameAr: 'ليلة العرس', duration: '6–10 hours (9 PM – dawn)', color: '#EF4444',
...
export const BRIDAL_OUTFITS: BridalOutfit[] = [
  { name: 'Takchita', nameAr: 'تكشيطة', region: 'National', description: 'Two-piece silky dress with wide embroidered belt (mdamma). White or gold. The entrance outfit — worn on the Amariya.', color: '#FACC15' },
  { name: 'Fassiya', nameAr: 'الفاسية', region: 'Fes', description: 'Fes-style kaftan. Heavy brocade, rich gold embroidery. Often accompanied by a jeweled crown (taj).', color: '#A855F7' },
...
export const REGIONAL: RegionalVariation[] = [
  ...
  { region: 'Jewish Moroccan', note: 'Shared henna tradition (the Hina). Mikveh replaces hammam. No fasting before ceremony. Ketubah signed under chuppah. Bride and groom join guests immediately — no Yichud.', color: '#3B82F6' },
]
