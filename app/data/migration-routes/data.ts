...
export const ROUTES: Route[] = [
  {
    ...
    description: 'The strait between two continents. At its narrowest, 13 kilometres separate Morocco from Spain — the closest point between Africa and Europe. Migrants cross by small boats (pateras), rubber dinghies, jet skis, or by swimming. This route also includes overland crossings into the Spanish enclaves of Ceuta and Melilla.',
    ...
    status: 'In 2018, 56,000+ reached Spain via this route — the most active that year. Morocco prevents 45,000+ crossings in 2024. Since the 2022 Melilla massacre, overland crossings have decreased; more attempt sea routes or redirect via Algeria to Tunisia.',
  },
  {
    id: 'atlantic',
    name: 'West African Atlantic Route',
    description: 'The deadliest route. From West African coastal countries or Morocco\'s Atlantic coast, migrants sail toward the Spanish Canary Islands — 100 km off the African coast — or attempt the longer crossing to mainland Spain. In 2024, this became the most active irregular passage from Africa to Europe.',
    ...
    dangers: 'Open ocean. 10,457 dead or missing on this route in 2024 — a record. Overcrowded wooden boats (cayucos/pirogues). Dehydration, exposure, engine failure. Bodies rarely recovered',
    status: '36,000 intercepted in 2024, the most active route. Increased 18% while other routes decreased. Mali was leading country of origin (~16,500). The shift reflects intensified EU-funded interdiction along the Mediterranean.',
  },
  {
    id: 'overland-east',
