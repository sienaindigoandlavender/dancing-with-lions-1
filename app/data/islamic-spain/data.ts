...
export const ERAS: Era[] = [
  ...
  },
  {
    ...
    range: '929–1031',
    color: '#FCBF49',
    summary: 'Abd al-Rahman III declares a caliphate. Córdoba becomes the largest, most literate city in Europe. The golden age.',
  },
  {
    id: 'taifas',
    ...
    range: '1031–1086',
    color: '#72EFDD',
    summary: 'The caliphate fractures into ~30 rival kingdoms. Brilliant culture, military weakness. Toledo falls to Castile.',
  },
  {
    id: 'berber',
...
export const TIMELINE: TimelineEvent[] = [
  ...
  },
  {
    ...
    detail: 'Charles Martel halts the Muslim advance near Poitiers. The high-water mark in Western Europe. The frontier stabilizes along the Pyrenees.',
    era: 'conquest',
    major: true,
  ...
  // THE CALIPHATE
  {
    ...
    detail: 'After 17 years crushing revolts and unifying the peninsula, he claims the title of Caliph — challenging both Baghdad and Cairo. The golden age begins. His 49-year reign is the longest.',
    era: 'caliphate',
    major: true,
    dataValue: '49',
  ...
  // NASRID EMIRATE & FALL
  {
    ...
    detail: 'Muhammad I founds the last Muslim state in Iberia. A vassal of Castile from the beginning — paying tribute, providing troops, surviving on diplomacy. It works for 254 years.',
    era: 'fall',
    major: true,
  ...
  },
  {
    ...
    detail: 'Philip III expels the last descendants of Al-Andalus. ~300,000 people forced across the Mediterranean — to Morocco, Tunisia, Algeria, the Ottoman Empire. They carry recipes, music, architecture, and grief.',
    era: 'fall',
    major: true,
    dataValue: '~300,000',
    dataLabel: 'expelled',
