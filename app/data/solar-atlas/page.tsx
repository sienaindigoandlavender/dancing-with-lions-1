    ...
    <div className="-mt-16">
      ...
      <section className="bg-white">
        <div className="max-w-wide mx-auto px-6 md:px-10 py-section">
          ...
          <h2 className="font-serif text-[28px] md:text-[36px] italic text-dwl-black leading-[1.05] mb-4">Four Phases, One Desert</h2>
      ...
      {/* ═══ QUOTE ═══ */}
      <section className="py-section flex items-center justify-center min-h-[38vh]" style={{ background: '#F59E0B' }}>
        <div className="max-w-[720px] px-6 md:px-10 text-center">
          ...
          <p className="text-[12px] mt-4" style={{ color: 'rgba(255,255,255,0.6)' }}>— Youssef Stitou, MASEN Project Engineer</p>
        </div>
      </section>
      ...
      <section style={{ background: '#0a0a0a' }}>
        <div className="max-w-wide mx-auto px-6 md:px-10 py-section">
          ...
          <h2 className="font-serif text-[28px] md:text-[36px] italic leading-[1.05] mb-4" style={{ color: '#ffffff' }}>MASEN&rsquo;s Solar Network</h2>
          <p className="text-[14px] mb-6" style={{ color: 'rgba(255,255,255,0.4)' }}>Click markers for project details.</p>
      ...
      <section className="bg-white">
        <div className="max-w-wide mx-auto px-6 md:px-10 py-section">
          ...
          <h2 className="font-serif text-[28px] md:text-[36px] italic text-dwl-black leading-[1.05] mb-12">Where the Sun Hits Hardest</h2>
      ...
      <section style={{ background: '#0a0a0a' }}>
        <div className="max-w-wide mx-auto px-6 md:px-10 py-section">
          ...
          <h2 className="font-serif text-[28px] md:text-[36px] italic leading-[1.05] mb-4" style={{ color: '#ffffff' }}>What Powers Morocco Today</h2>
          <p className="text-[14px] max-w-[560px] leading-relaxed mb-10" style={{ color: 'rgba(255,255,255,0.4)' }}>Coal still dominates. But the trajectory is clear.</p>
      ...
      <section className="bg-white">
        <div className="max-w-wide mx-auto px-6 md:px-10 py-section">
          ...
          <h2 className="font-serif text-[28px] md:text-[36px] italic text-dwl-black leading-[1.05] mb-8">From Strategy to Megawatts</h2>
      ...
      <section className="py-section flex items-center justify-center min-h-[38vh]" style={{ background: '#0a0a0a' }}>
        <div className="max-w-[720px] px-6 md:px-10 text-center">
          ...
          <p className="text-[12px] mt-4" style={{ color: 'rgba(255,255,255,0.35)' }}>— Xlinks testimony to UK Parliament</p>
        </div>
      </section>
