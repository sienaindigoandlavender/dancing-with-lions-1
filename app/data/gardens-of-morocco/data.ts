...
export const GARDENS: Garden[] = [
  {
    ...
    unescoYear: '1985',
    description: 'The oldest preserved park in Marrakech and one of the oldest functioning landscaped parks on earth. A royal agricultural estate where divine geometry meets productive orchards. The Almohad vision: a city should equal its gardens in size. The surface of the Agdal and Menara combined equalled the surface of the Almohad capital.',
    ...
    visitors: 'Royal property. Open to public on Fridays and Sundays (when king is not in residence). Far fewer tourists than Majorelle or Menara — a peaceful, authentic encounter.',
  },
  {
    id: 'menara',
    name: 'Menara Gardens',
  ...
  },
  {
    ...
    unescoYear: null,
    description: 'A psychedelic desert mirage. 300 plant species from five continents orbiting a Cubist villa drenched in trademarked cobalt blue. Morocco\'s most visited tourist attraction (~900,000 visitors/year). Created by a French painter, saved by a French couturier. Where Art Nouveau met the Sahara.',
    ...
    architecture: 'Cubist villa designed by architect Paul Sinoir (1931) — astonishing Art Deco modernity. Majorelle\'s studio/workshop on ground floor, living quarters above. The trademark "Majorelle Blue" (bleu Majorelle, hex #6050DC) — a bold cobalt inspired by Moroccan tiles, the bold sky, and Tuareg blue veils. First applied 1937, trademarked. Villa now houses the Berber Museum (600+ artefacts, inaugurated by King Mohammed VI). Villa Oasis (renamed by YSL) was private residence. Musée Yves Saint Laurent (2017) next door. Bill Willis designed boutique and café.',
    history: [
  ...
  },
  {
    ...
    unescoYear: null,
    description: 'The green lung of Fez. "Jnan" derives from "jannah" — Arabic for both "garden" and "paradise." Located between Fes el-Jdid and Fes el-Bali, the two halves of the old city. Originally exclusive to royals (connected to the palace by underground tunnel), opened to public in 1917. The oldest and most prestigious public garden in Morocco\'s spiritual capital.',
    ...
    plants: '3,000+ species. Themed sub-gardens: Andalusian Garden, Mexican Garden, Bamboo Garden, Fragrance Garden (southeast, created during 2010 restoration). Giant bamboos, Washingtonia palms, pine, eucalyptus, weeping willows, orange groves, date palms. Trees over 100 years old. Majestic central tree-lined mall.',
...
export const ISLAMIC_GARDEN_PRINCIPLES: DesignPrinciple[] = [
  { name: 'Chahar Bagh (Four-Fold Garden)', arabic: 'چهارباغ', description: 'The garden divided into four quadrants by water channels intersecting at a central fountain or pavilion. Derived from Qur\'anic descriptions of paradise with four rivers (water, milk, wine, honey). Persian origin, transmitted through the Umayyad and Abbasid caliphates to the Maghreb via Al-Andalus.', examples: 'Le Jardin Secret (Marrakech) preserves this form most clearly. The Alhambra\'s Generalife and Court of the Lions. The Taj Mahal gardens.' },
  { name: 'Water as Sacred Element', arabic: 'الماء', description: 'Water is the origin of all life in the Qur\'an ("We made from water every living thing" — 21:30). In Marrakech — a city at the gateway to the Sahara — water is sacred luxury. Every Moroccan village centres on a fountain for ablutions before prayer. In the garden, water is channelled, displayed, heard. Pools reflect sky and architecture. Sound of flowing water is integral to design.', examples: 'Menara\'s vast reflecting pool. Agdal\'s 83,000 m³ reservoir. Majorelle\'s marble channels. Jnan Sbil\'s zellige fountains.' },
  { name: 'Enclosure (Hortus Conclusus)', arabic: 'الجنان المسوّر', description: 'The garden is walled — separated from the outside world. A contained paradise. "Agdal" literally means "meadow enclosed by a stone wall" in Berber. The wall creates an inversion: chaos outside, order within. The wall also provides shade, thermal regulation, and wind protection in arid climates.', examples: 'Agdal\'s massive enclosing walls. Jnan Sbil between the ramparts. Riad courtyard gardens throughout Moroccan medinas.' },
  { name: 'Geometry & Order', arabic: 'الهندسة', description: 'Strict geometric organisation reflects divine order. Trees planted in grids (typically 10m). Paths intersect at right angles. Sub-gardens are rectangular. Each plot cultivates one species. The Hispano-Mauresque "productive garden" tradition: rationalism in service of both beauty and agriculture. Geometry is spiritual — the expression of tawhid (divine unity) through mathematical precision.', examples: 'Agdal\'s 3,000 olive trees in geometric checkerboard. Menara\'s 10m grid orchards. Jnan Sbil\'s symmetrical pathways.' },
  { name: 'Shade & Sensory Experience', arabic: 'الظل والحواس', description: 'Gardens engage all senses: sight (geometry, colour, reflected light), sound (flowing water, birdsong), smell (jasmine, orange blossom, musk), touch (cool air, stone, water), taste (fruit from the orchard). Shade is as designed as sunlight. Canopy layers: tall palms above, fruit trees in middle, ground cover below. The garden as a complete sensory environment.', examples: 'Majorelle\'s chromatic intensity. Jnan Sbil\'s fragrance garden. Agdal\'s layered orchards producing fruit for the royal table.' },
  { name: 'Productive Beauty', arabic: 'الجمال المنتج', description: 'Unlike European ornamental gardens, the Islamic tradition sees no contradiction between beauty and productivity. Orchards are gardens. Agriculture is art. The Almohad vision was explicitly strategic: food self-sufficiency through beautiful engineering. The reservoir irrigates the orchard which feeds the city which funds the empire.', examples: 'Agdal\'s 500-hectare working orchard. Menara\'s olive groves still producing. The Palmeraie\'s three-tier oasis agriculture (palm canopy, citrus middle layer, ground crops).' },
]
...
export const WATER_SYSTEMS: WaterSystem[] = [
  ...
  { name: 'Seguia', arabic: 'ساقية', description: 'Surface irrigation channels/ditches that distribute water from reservoirs to orchards. The arteries of the garden. In Fez, seguias from the Oued Fes powered craft workshops and irrigated gardens simultaneously.', engineering: 'Open or partially covered channels, often lined with stone or rammed earth. Water flow regulated by gates and sluices. Distribution follows strict communal calendars — traditional water-sharing systems respected by all communities.' },
...
export const HISTORY: HistoryEvent[] = [
  ...
  { year: '1923', event: 'Jacques Majorelle purchases a palm grove in Marrakech and begins planting what will become the world\'s most Instagrammed garden', thread: 'modern' },
  ...
  { year: '2017', event: 'Musée Yves Saint Laurent opens next to Jardin Majorelle. Villa houses Berber Museum with 600+ artefacts. The garden becomes a cultural campus', thread: 'modern' },
]
...
export const KEY_NUMBERS = [
  ...
  { number: '#6050DC', unit: '', context: 'Majorelle Blue — the hex code of the trademarked cobalt that defines Jardin Majorelle. Inspired by Moroccan tiles, the bold sky, and Tuareg blue veils' },
  { number: '1870', unit: '', context: 'Year the current Menara pavilion was completed — on the ruins of a 16th-century Saadian original. Green pyramidal roof, horseshoe arches, zellige. The most photographed building in Marrakech' },
  { number: '7.5', unit: 'hectares', context: 'Jnan Sbil — Fez\'s green lung. "Jnan" from "jannah" (paradise). 3,000 species. Underground passage to the Royal Palace. Free admission' },
  { number: '900,000', unit: 'visitors/year', context: 'Jardin Majorelle — Morocco\'s most visited tourist attraction. One hectare. Created by a painter, saved by a couturier. A psychedelic desert mirage in cobalt blue' },
]
