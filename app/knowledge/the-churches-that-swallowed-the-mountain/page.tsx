...
export default function TheChurchesThatSwallowedTheMountain() {
    ...
    <div style={{ background: C.bg, color: C.ink }}>
      ...
      <Sec bg={C.alt}>
        <Fade>
          ...
          <Title>The Zagwe's answer was not a genealogy. It was architecture.</Title>
        </Fade>
        <Fade delay={100}>
          <Prose>The Zagwe faced a legitimacy problem from the start. They could not claim descent from the Aksumite kings. Their answer: by building a physical Jerusalem in Ethiopia, they asserted that God's favour had shifted to their dynasty. They did not need Solomon's blood. They had Solomon's city.</Prose>
      ...
      <footer>
        <div style={{ background: '#1f1f1f', padding: '40px 24px' }}>
          <div style={{ maxWidth: 900, margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 16 }}>
            ...
            <span style={{ fontFamily: F.mono, fontSize: 11, color: 'rgba(255,255,255,0.25)' }}>Dancing with Lions · Knowledge</span>
          </div>
        </div>
