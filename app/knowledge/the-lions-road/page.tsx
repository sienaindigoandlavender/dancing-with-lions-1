...
// ── MAIN ──
export default function TheLionsRoad() {
      ...
      <footer>
        <div style={{ background: '#1f1f1f', padding: '40px 24px' }}>
          <div style={{ maxWidth: 800, margin: '0 auto', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 16 }}>
            ...
            <span style={{ fontFamily: 'var(--font-plex-mono), monospace', fontSize: 11, color: 'rgba(255,255,255,0.25)' }}>Dancing with Lions · Cultural Intelligence</span>
          </div>
        </div>
        <div style={{ background: '#161616', padding: '20px 24px', textAlign: 'center' as const }}>
          <span style={{ fontFamily: 'var(--font-plex-mono), monospace', fontSize: 10, color: 'rgba(255,255,255,0.2)' }}>© {new Date().getFullYear()} Dancing with Lions · J. Ng</span>
        </div>
